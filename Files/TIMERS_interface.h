...
typedef struct My_Struct77
{
	u8 Timer_Mode;
	u8 Timer_Prescalar;
	u16 Timer_Value;
	u8 Timer_State;			//In case of Compare match and PWM
	u8 Timer_Channel;		//In case of Timer 1 Compare match and PWM
	u16 Timer_Top_Value;		//In case of Timer 1 PWM
}Timer_t;
